...
load data local infile './PersonName.del' into table PersonName fields terminated by ',' optionally enclosed by '"';
load data local infile './OrgName.del' into table OrgName fields terminated by ',' optionally enclosed by '"';
